...
var resizer = {
  ...
  fixupTitle: function(doc) {
    ...
    // Replace strings of multiple spaces with one space. For some fun reason,
    // Firefox does this anyway when reading document.title, which will
    // cause this function to loop constantly if we don't do it too.
